...
| ② Cache Breakpoint 上下文压缩 | `app/compress/` | ⏳ 待学习 | ❌ 未实现 |
...
│   ├── 01_简历第一条_多Agent架构学习.md  ★ 简历①完整学习（面试/代码/实习）
│   ├── 次生产级灰度模拟可行性评估.md
│   └── 原文档与次生产级差别.md
...
1. 再读 `文档/原文档与次生产级差别.md` 和 `文档/次生产级灰度模拟可行性评估.md`，
   分清「原文内核」和「ops 补丁」。
2. 看本 README 建立文件树与简历四条落点。
3. 复习某一条时，打开对应目录下的文件读"做什么/解决的问题/连接/技术栈"。
4. 需要眼见为实（如并行提速），去 `demos/` 跑脚本。
5. 学习对错记录在 `简历内容学习与面试准备/00_学习进度与复盘笔记.md`。
